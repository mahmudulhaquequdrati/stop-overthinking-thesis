...
⬅️ [ROADMAP](../ROADMAP.md) · ➡️ [Lesson 01](01-what-is-an-llm.md)

---

## 1. In one sentence

**A thesis is a question nobody has answered yet, answered with evidence you collected, and written so that someone else can check it.**
...
| **Checkable** | Someone else could repeat it and get the same result | The recipe and the test are written down |
...
And the **proof**: numbers from the same test problems, before vs after training.

If the claim turns out wrong, **that is still a thesis**, as long as the proof is honest:
...
| Gap | Nobody compared "train it shorter" vs "switch thinking OFF" on one small model, for code |
| Question | Can training make it think shorter, keep accuracy, and beat the OFF switch? |
| Hypothesis | ≥25% less thinking, accuracy within 3 points, better than OFF |
...
- **Baseline:** the normal way, which you compare against. Without a baseline, "better" means nothing.
...
<details><summary>Answer</summary>
No. An honest negative result is still an answer to the question. You explain *why*
it failed. What ruins a thesis is hiding bad results, not having them.
</details>
...
alternatives: thinking OFF, a thinking budget, and a "think briefly" prompt.
</details>
